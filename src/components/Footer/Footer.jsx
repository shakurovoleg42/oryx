        ...
        <div className="footer_section">
            <div className="footer_top">
                <div className="telephones_numbers">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25.53" height="25.33" fill="#FFFFFF" class="bi bi-telephone-fill" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877z"/>
                    </svg>
                    <p className="tel_number">
                        <a href="tel:+7 700 323 22 22" type="tel" style={{ textDecoration: "none", color: "#D6D6D6"}}>
                            +7 700 323 22 22
                        </a>
                    </p>
                    <p className="tel_number">
                        <a href="tel:+7 747 515 56 13" type="tel" style={{ textDecoration: "none", color: "#D6D6D6"}}>
                            +7 747 515 56 13 
                        </a>
                    </p> 
                </div>
                <div className="instagram">
                    ...
                    <p className="to_instagram" style={{marginLeft: "9px"}}>

            ...
            <div className="footer_top">
                <div className="telephones_numbers">
                    ...
                    <p className="tel_number">
                        <a href="tel:+7 700 323 22 22" style={{ textDecoration: "none", color: "#D6D6D6"}}>
                            +7 700 323 22 22
                        </a>
                    </p>
                    <p className="tel_number">
                        <a href="tel:+7 747 515 56 13" style={{ textDecoration: "none", color: "#D6D6D6"}}>
                            +7 747 515 56 13 
                        </a>
                    </p> 
                </div>
                <div className="instagram">
                    ...
                    <p className="to_instagram" style={{marginLeft: "3px"}}>
                        <a href="#!" style={{ textDecoration: "none", color: "#D6D6D6", display: "inline-block" }}>
                            @oryx.usa.kz
                        </a>
                    </p>
                </div>
